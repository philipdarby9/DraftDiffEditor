...
contextBridge.exposeInMainWorld("draftDiffDesktop", {
  ...
  openPath: filePath => ipcRenderer.invoke("draft-diff:open-path", String(filePath || "")),
  showItemInFolder: filePath => ipcRenderer.invoke("draft-diff:show-item-in-folder", String(filePath || "")),
